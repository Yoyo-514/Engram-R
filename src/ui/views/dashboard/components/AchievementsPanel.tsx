      ...
      <div className="bg-muted/10 p-3 rounded-lg border border-border/30 flex items-center gap-4">
        ...
        <div className="flex-shrink-0 flex items-center gap-2 flex-wrap justify-end max-w-[50%]">
          ...
          {activeDaysCount >= 100 && activeRatio >= 50 ? (
            <div
              className="text-[10px] flex items-center gap-1 text-red-500 font-medium bg-red-500/10 px-2 py-1 rounded-full border border-red-500/20"
              title="连续活跃 100 天"
            >
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-rose-400 font-medium bg-rose-400/10 px-2 py-1 rounded-full border border-rose-400/20"
              title="连续活跃 30 天"
            >
              <Flame size={12} fill="currentColor" />
              忠实用户
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-orange-400 font-medium bg-orange-400/10 px-2 py-1 rounded-full border border-orange-400/20"
              title="连续活跃 7 天"
            >
              <Flame size={12} />
              活跃初见
          ...
          {stats.totalTokens >= 10000000 ? (
            <div
              className="text-[10px] flex items-center gap-1 text-purple-500 font-medium bg-purple-500/10 px-2 py-1 rounded-full border border-purple-500/20"
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-purple-400 font-medium bg-purple-400/10 px-2 py-1 rounded-full border border-purple-400/20"
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-purple-300 font-medium bg-purple-300/10 px-2 py-1 rounded-full border border-purple-300/20"
              title="消耗 10 万 Token"
            >
              <Star size={10} />
              十万 Token
          ...
          {stats.totalEvents >= 10000 ? (
            <div
              className="text-[10px] flex items-center gap-1 text-emerald-500 font-medium bg-emerald-500/10 px-2 py-1 rounded-full border border-emerald-500/20"
              title="生成 10,000 条记忆"
            >
              <LibraryBig size={12} />
              万卷藏书
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-emerald-400 font-medium bg-emerald-400/10 px-2 py-1 rounded-full border border-emerald-400/20"
              title="生成 1,000 条记忆"
            >
              <LibraryBig size={12} />
              千思之录
          ...
          {stats.totalRagInjections >= 5000 ? (
            <div
              className="text-[10px] flex items-center gap-1 text-blue-500 font-medium bg-blue-500/10 px-2 py-1 rounded-full border border-blue-500/20"
              title="成功召回 5,000 次"
            >
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-blue-400 font-medium bg-blue-400/10 px-2 py-1 rounded-full border border-blue-400/20"
              title="成功召回 1,000 次"
            >
              <Zap size={12} />
              记忆编织者
            ...
            <div
              className="text-[10px] flex items-center gap-1 text-blue-300 font-medium bg-blue-300/10 px-2 py-1 rounded-full border border-blue-300/20"
              title="成功召回 100 次"
            >
              <Zap size={10} />
              初窥门径
