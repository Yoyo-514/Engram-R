...
export const Dashboard: FC<DashboardProps> = ({ onNavigate }) => {
  ...
  const { system, memory, features, brainStats, contextStats, globalStats, toggleFeature } =
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      / {brainStats.shortTermLimit}
                    </span>
                  </div>
                  {/* 活跃项预览 */}
                  <div className="mt-3 space-y-1">
                    {brainStats.topItems.map((item) => (
                      <div
                        key={item.id}
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[10px] text-meta">
                      {contextStats.injectedLength.toLocaleString()} chars
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    <div key={key} className="flex items-center justify-between">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <span
                            className={`text-sm ${isEnabled ? 'text-heading' : 'text-muted-foreground'}`}
                          >
                            {label}
                          </span>
