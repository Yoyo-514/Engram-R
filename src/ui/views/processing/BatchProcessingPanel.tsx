  ...
  const handleScan = async () => {
    ...
    try {
      ...
      const pending = allEvents.filter(
        (e) => e.is_embedded && !e.is_archived && e.level === 0
      ).length;
      ...
      <div className="bg-card/30 border-border/30 space-y-3 rounded-lg border p-4">
        ...
        {archiveStats && (
          <div className="bg-muted/20 space-y-1 rounded p-2 text-xs">
            ...
            <div className="flex justify-between">
              ...
              <span
                className={`font-mono ${archiveStats.pending > 0 ? 'text-amber-400' : 'text-value'}`}
              >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {isArchiving
              ? '归档中...'
              : `归档${archiveStats?.pending ? ` (${archiveStats.pending})` : ''}`}
          </button>
        </div>
      </div>
    </section>
...
export const BatchProcessingPanel: FC = () => {
  // 使用 Workflow Hook
  const { queue, currentTask, pause, resume, stop, clear } = useWorkflow();
  ...
  const overallPercent =
    queue?.overallProgress && queue.overallProgress.total > 0
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-value">
                    ~{(analysis.estimatedTokens / 1000).toFixed(0)}k
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <div className="mt-1 flex justify-between font-mono text-[11px] text-meta">
                ...
                <span
                  className={
                    queue.isPaused ? 'text-emphasis' : queue.isRunning ? 'text-primary' : ''
                  }
                >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div>
                <span
                  className={`text-sm ${importMode === 'fast' ? 'text-foreground' : 'text-muted-foreground'}`}
                >
                  快速模式
                </span>
            ...
            >
              ...
              <div>
                <span
                  className={`text-sm ${importMode === 'detailed' ? 'text-foreground' : 'text-muted-foreground'}`}
                >
                  精细模式
                </span>
