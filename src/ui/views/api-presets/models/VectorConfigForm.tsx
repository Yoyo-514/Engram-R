 ...
 */
const DeploymentDiagnostics: FC<{ url: string }> = ({ url }) => {
  if (!url) return null;
...
export const VectorConfigForm: FC<VectorConfigFormProps> = ({ config, onChange }) => {
        ...
        {needsUrl && (
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder={
                config.source === 'ollama' ? 'http://localhost:11434' : 'http://localhost:8000'
              }
              style={{
