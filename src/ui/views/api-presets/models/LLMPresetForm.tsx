...
export const LLMPresetForm: FC<LLMPresetFormProps> = ({ preset, onChange }) => {
  // 模型列表状态 (自定义 API 用)
  ...
  // 更新自定义配置
  const updateCustom = <K extends keyof CustomAPIConfig>(key: K, value: CustomAPIConfig[K]) => {
      ...
      {preset.source === 'custom' && (
        <FormSection title="API 配置" description="自定义 API 端点和密钥">
          <SelectField
            ...
            onChange={(value) => updateCustom('apiSource', value as APISource)}
            ...
            onChange={(value) => {
              ...
              updatePreset({
                retryConfig: {
                  ...
                  retryDelay: preset.retryConfig?.retryDelay ?? 2000,
                },
              });
            }}
            placeholder="3"
          ...
          <TextField
            ...
            onChange={(value) => {
              ...
              updatePreset({
                retryConfig: {
                  ...preset.retryConfig,
                  maxAttempts: preset.retryConfig?.maxAttempts ?? 3,
